...
<?php if(isset($_SESSION["email"])){?>
    ...
    <main>
        <h2 style="margin-left: 600px;color: coral;">Update Course</h2>
       <form action="../includes/update_ins_course.inc.php" method="post" enctype="multipart/form-data"  onsubmit="return validateForm() &&  confirmUpdate()">
       <label for="scourse">Select Course</label>
        ...
        <label for="cat">Update Category</label>
        ...
        <label for="thumbnil">Update Thumbnil</label>
