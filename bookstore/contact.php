...
<head>
	<title>anik158 | Ahsan's BookHive</title>
	<meta charset="utf-8" />
		...
		<header id="header">
			<div class="inner">
				...
				<a href="index.php" class="logo">
					<span class="fa fa-book"></span> <span class="title">Ahsan's BookHive</span>
				</a>
		...
		<footer id="footer">
			<div class="inner">
				...
				<ul class="copyright">
					...
					<li>Template by: <a href="https://www.phpjabbers.com/">anik158</a></li>
				</ul>
			</div>
		</footer>
